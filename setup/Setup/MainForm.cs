...
namespace Terraria.ModLoader.Setup
{
	public partial class MainForm : Form, ITaskInterface
	{
		...
		public MainForm()
		{
			...
			taskButtons[buttonDiffModLoader] = () => new DiffTask(this, "src/Terraria", "src/TerrariaPlus", "patches/TerrariaPlus", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
			taskButtons[buttonPatchModLoader] = () => new PatchTask(this, "src/Terraria", "src/TerrariaPlus", "patches/TerrariaPlus", new ProgramSetting<DateTime>("tModLoaderDiffCutoff"));
